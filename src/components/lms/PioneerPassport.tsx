    ...
    <div className="flex flex-col items-center justify-center p-4 sm:p-8 bg-slate-50 dark:bg-[#080a10] border-y border-black/5 dark:border-white/5 w-full transition-colors duration-700">
      <div className="text-center mb-8 sm:mb-12">
        ...
        <p className="text-gray-500 text-[10px] sm:text-sm max-w-[280px] sm:max-w-md mx-auto leading-relaxed">
          Every lesson, every challenge, every victory—immortalized in your
          digital passport.
        </p>
      </div>
                ...
                <div className="w-24 h-24 rounded-full bg-linear-to-br from-blue-500 to-indigo-600 dark:from-violet-500 dark:to-pink-500 p-[2px] shadow-[0_10px_30px_rgba(59,130,246,0.3)] dark:shadow-[0_0_20px_rgba(124,58,237,0.3)]">
                  <div className="w-full h-full rounded-full bg-white dark:bg-slate-900 flex items-center justify-center overflow-hidden">
                    <img
                      src={
                        user?.imageUrl ??
                        "https://api.dicebear.com/7.x/avataaars/svg?seed=Pioneer77"
                      }
                      alt="Pioneer Avatar"
          ...
          <div className="absolute inset-0 w-full h-full backface-hidden ring-1 ring-slate-200 dark:ring-white/10 rounded-[32px] overflow-hidden bg-white dark:bg-slate-950 shadow-[0_20px_50px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.5)] transform rotateY-180">
            ...
            <div className="relative p-6 flex flex-col h-full">
              ...
              <div className="mt-8 text-center flex flex-col items-center">
                ...
                <p className="text-[7px] font-medium text-gray-600 uppercase tracking-widest">
                  Issued via EduNova Alpha Protocol
                </p>
              </div>
            </div>
          </div>
