...
export default function CoursesPage() {
  ...
  return (
    <div className="min-h-screen mx-auto">
      <Navbar />
      <main
        className={`${montserrat.className} max-w-5xl mx-auto min-h-screen bg-background text-foreground pt-20 mb-16`}
      >
        <div className="max-w-6xl mx-auto px-6 py-10">
          ...
          <div>
            {filtered.length > 0 && isSearchMode ? (
              ...
              <div className="mb-6">
                <h1 className="font-serif text-4xl md:text-6xl font-black text-white leading-tight mb-1">
                  Browse All{" "}
                  <span
                ...
                <p className="text-gray-500 text-sm">
                  Search, filter, and find the right course according to your
                  goal.
                </p>
              </div>
            )}
            ...
            >
              <Search size={15} className="ml-4 text-violet-400 shrink-0" />
              <input
                value={query}
            ...
            {chips.length > 0 && (
              <div className="mb-6">
                <p className="text-[10px] font-bold uppercase tracking-widest text-gray-600 mb-2.5 flex items-center gap-1.5">
                  <TrendingUp size={11} className="text-violet-500" /> More to
                  explore
                </p>
            ...
            >
              ...
              <select
                ...
                className="ml-auto bg-transparent border border-violet-500/20 text-gray-400 text-xs rounded-lg px-3 py-1.5 focus:outline-none cursor-pointer"
              >
                <option className="bg-black font-semibold" value="popular">
                  Most Popular
                </option>
                <option className="bg-black font-semibold" value="rating">
                  Top Rated
                </option>
                <option className="bg-black font-semibold" value="priceLow">
                  Price ↑
                </option>
                <option className="bg-black font-semibold" value="priceHigh">
                  Price ↓
                </option>
              </select>
            </div>
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-20">
              ...
              <p className="text-gray-500 text-sm mb-6">
                ...
                <span className="text-violet-300">{query}</span>&rdquo;. Try a
                related keyword or browse all.
              </p>
              <button
                onClick={clearSearch}
