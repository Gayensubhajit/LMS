        ...
        {STATS.map((stat, idx) => {
          ...
          return (
            <motion.div
              ...
              className="p-6 rounded-3xl bg-white/5 border border-white/5 hover:border-blue-500/30 transition-all duration-500 group relative overflow-hidden"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-center justify-between px-2">
            ...
            <button className="text-[10px] font-black text-blue-400 hover:text-white uppercase tracking-widest transition-colors">View All Logs</button>
          </div>
        ...
        <div className="space-y-6">
          ...
          <div className="p-8 rounded-3xl bg-gradient-to-br from-blue-600/20 to-transparent border border-blue-500/10 relative overflow-hidden group">
            <div className="relative z-10">
              ...
              <div className="text-4xl font-black text-white mb-1">1,280</div>
              <div className="text-sm text-gray-500 font-medium mb-4">Total Users</div>
