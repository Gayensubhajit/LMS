              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-white/5 border border-white/10 flex items-center justify-center mb-8 shadow-inner animate-pulse">
                  {activeTab === "subscriptions" ? (
                    ...
                    <History size={32} className="text-sky-400" />
                  )}
                </div>
            ...
            <div className="relative bg-slate-950/90 backdrop-blur-3xl rounded-[2.95rem] p-10 sm:p-14 lg:p-20 flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
              <div className="flex-1 text-center lg:text-left">
                <div className="flex items-center justify-center lg:justify-start gap-4 mb-8">
                  ...
                  <span className="px-3 py-1 rounded-full bg-violet-500/10 border border-violet-500/20 text-[9px] font-black text-violet-400 uppercase tracking-widest animate-pulse">
                    Alpha Access
                  </span>
                </div>
              ...
              {freeCourses.map((course, i) => (
                ...
                >
                  <div className="h-44 relative overflow-hidden bg-slate-800">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="px-3 py-1 rounded-full bg-sky-500/20 backdrop-blur-md border border-sky-500/30 text-[8px] font-black text-white uppercase tracking-widest">
                        Free lab
                      </span>
                    </div>
                  </div>
                  <div className="p-8 flex-1 flex flex-col justify-between">
                    <div>
                      ...
                      <h4 className="text-sm font-black text-white tracking-tight mb-4 group-hover/card:text-sky-400 transition-colors leading-snug line-clamp-2">
                        {course.title}
                      </h4>
                    </div>
                    <div>
              ...
              {degrees.map((item, i) => (
                ...
                >
                  <div className="h-44 relative overflow-hidden bg-slate-800">
                    ...
                    />
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${item.color} mix-blend-overlay opacity-40`}
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-transparent to-transparent opacity-80" />

                    {/* Badge from Inspiration */}
                    <div className="absolute top-4 right-4 animate-bounce-slow">
                      <span className="px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-[7px] font-black text-white uppercase tracking-widest">
                        Hands-On Projects
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="p-8 flex-1 flex flex-col justify-between">
                    <div className="space-y-4">
                      ...
                      <h4 className="text-sm sm:text-base font-black text-white tracking-tight group-hover/card:text-pink-400 leading-tight transition-all line-clamp-3">
                        {item.title}
                      </h4>
                    </div>
