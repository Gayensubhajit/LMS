...
export const coursesData: Course[] = [
  // ── FREE COURSES ──────────────────────────────────────────────────────────
  {
    ...
    shortDescription: "Complete the 12-step path from Programmer to AI Engineer in this exclusive course.",
    longDescription:
      "A fully comprehensive AI Engineering course mapping directly to the 12-step roadmap. Learn the mathematics, frameworks, models, deployment, and research methodologies of the AI industry.",
    skills: ["Python", "Machine Learning", "Deep Learning", "LLMs", "Math", "MLOps"],
